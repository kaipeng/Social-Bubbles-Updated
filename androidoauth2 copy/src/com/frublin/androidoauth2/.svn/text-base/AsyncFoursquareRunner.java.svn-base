 ...
 */
public class AsyncFoursquareRunner {

	AndroidOAuth fs;

    public AsyncFoursquareRunner(AndroidOAuth fs) {
        this.fs = fs;
    }
...
//    }
    ...
    public void request(final String graphPath,
        ...
        new Thread() {
            @Override public void run() {
                try {
            		String accessToken = fs.getSavedAccessToken();
            		Log.d("Foursquare Search: ", "Token = " + accessToken);
                    String resp = fs.request(graphPath, parameters, httpMethod);
